...
class SolidityListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SolidityParser#functionCallTail.
    def enterFunctionCallTail(self, ctx:SolidityParser.FunctionCallTailContext):
        pass

    # Exit a parse tree produced by SolidityParser#functionCallTail.
    def exitFunctionCallTail(self, ctx:SolidityParser.FunctionCallTailContext):
        pass


    # Enter a parse tree produced by SolidityParser#keyValueList.
    def enterKeyValueList(self, ctx:SolidityParser.KeyValueListContext):
        pass

    # Exit a parse tree produced by SolidityParser#keyValueList.
    def exitKeyValueList(self, ctx:SolidityParser.KeyValueListContext):
        pass


    # Enter a parse tree produced by SolidityParser#keyValue.
    def enterKeyValue(self, ctx:SolidityParser.KeyValueContext):
        pass

    # Exit a parse tree produced by SolidityParser#keyValue.
    def exitKeyValue(self, ctx:SolidityParser.KeyValueContext):
        pass
